...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `users`(`Id`, `firstName`, `lastName`, `email`) VALUES (NULL,'$firstName','$lastName','$email')";
  ...
  Call Of Duty League Casters
   ...
   <div class="container">
      <div class="text-center mb-4">
         <h3>Add New Caster</h3>
         <p class="text-muted">Complete the form below to add a new caster</p>
      </div>
