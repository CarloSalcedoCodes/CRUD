...
if (isset($_POST["submit"])) {
  ...
  if ($result) {
    header("Location: homepage.php?msg=Data updated successfully");
  } else {
...
<head>
  ...
  <title>Call Of Duty League Casters</title>
</head>
      ...
      <form action="" method="post" style="width:50vw; min-width:300px;">
        <div class="row mb-3">
          <div class="col">
            ...
            <input type="text" class="form-control" name="firstName" value="<?php echo $userRow['firstName'] ?>">
          </div>

          <div class="col">
            <label class="form-label">Last Name:</label>
            <input type="text" class="form-control" name="lastName" value="<?php echo $userRow['lastName'] ?>">
          </div>
        </div>
